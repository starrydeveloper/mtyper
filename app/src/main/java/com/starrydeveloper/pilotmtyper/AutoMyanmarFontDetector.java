...
public class AutoMyanmarFontDetector {
	...
	private final static String DETECT_STRING = "ဟုတ္ပါတယ္";
	...
	private void startFontDetecting() {
		...
		String checkText = fontTv.getText().toString();
		SharedPreferences.Editor editor = mSharedPreferences.edit();
		if(checkText.equals(DETECT_STRING)) {
