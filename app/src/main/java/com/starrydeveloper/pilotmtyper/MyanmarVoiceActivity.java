/*
*	ဤ m-Typer (Demo) version တြင္ ပါရွိေသာ code မ်ား method မ်ားသည္ Demo app အလုပ္လုပ္ရန္ 
*	သရုပ္ျပ ဖန္တီးထားျခင္းသား ျဖစ္ျပီး၊ ၄င္းတို႔ကို m-Typer ၏ release version မ်ားတြင္ တိုက္ရိုက္ ယူသံုးသြားမည္ 
*	မဟုတ္ေၾကာင္း သိေစအပ္ပါသည္။ 
*	
*/

package com.starrydeveloper.pilotmtyper;
